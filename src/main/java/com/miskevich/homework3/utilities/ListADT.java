package com.miskevich.homework3.utilities;
...
public interface ListADT<E> extends Serializable {
     ...
     * @throws NullPointerException      If the specified element is <code>null</code> and the
     ...
     * @throws NullPointerException      If the specified element is <code>null</code> and the list
     ...
     * @throws IndexOutOfBoundsException If the index is out of range:
     *                                   i.e. (<p><code>index &lt; 0 || index &gt;= size()</code></p>).
     */
     ...
     * <p><code>linearUtilities.Iterator</code></p>,
